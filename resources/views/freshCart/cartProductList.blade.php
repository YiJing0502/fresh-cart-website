...
<body>
  ...
  <div class="container-fluid d-flex h-100 w-100 p-0 border-end position-relative">
    ...
    <div class="left-menu appear l-height pe-4  position-absolute top-0 shadow ">
      <div class=" left-menu logo ps-4 d-flex align-items-center"><svg width="160" height="31" viewBox="0 0 160 31" fill="none"
        ...
        <div class="list-big">
          ...
          <div class="list  mb-self">
            ...
            <div class="row w-100   m-0 text-secondary fs-14-self py-2">
              ...
              <div class="col-1 d-flex justify-content-start align-items-center"><img src="./photo/product/1-removebg.png" class="img-size"></div>
              <div class="col-2 d-flex justify-content-start align-items-center">FC#1007</div>
              <div class="col-2 d-flex justify-content-start align-items-center">Jennifer Sullivan</div>
              <div class="col-2 d-flex justify-content-start align-items-center">01 May 2023 (10:12 am)</div>
              <div class="col-1 d-flex justify-content-center align-items-center"><span class="px-1 bg-green rounded">Success</span></div>
              <div class="col-1 d-flex justify-content-center align-items-center">$12.99</div>
              <div class="col-2 d-flex justify-content-center align-items-center flex-wrap">
                ...
                <button type="button" class="btn  btn-success  btn-success-self">Delete</button>
              </div>
            </div>
          </div>
        </div>
